...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11-Maio-2023 às 17:47
...
--
-- Banco de dados: `doctors_appointment_db`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `appointment_list`
--
...
--
-- Extraindo dados da tabela `appointment_list`
--
...
--
-- Estrutura da tabela `doctors_list`
--
...
--
-- Extraindo dados da tabela `doctors_list`
--
...
--
-- Estrutura da tabela `doctors_schedule`
--
...
--
-- Extraindo dados da tabela `doctors_schedule`
--
...
--
-- Estrutura da tabela `patient_list`
--
...
(11, 4, 'DR.BDUL, md', 'S', 'DFD', 'AD@GG.COM', '', 2);
...
--
-- Índices para tabela `appointment_list`
--
ALTER TABLE `appointment_list`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `doctors_list`
--
ALTER TABLE `doctors_list`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `doctors_schedule`
--
ALTER TABLE `doctors_schedule`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `medical_specialty`
--
ALTER TABLE `medical_specialty`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `patient_list`
--
...
--
-- AUTO_INCREMENT de tabela `doctors_list`
--
ALTER TABLE `doctors_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `doctors_schedule`
--
ALTER TABLE `doctors_schedule`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `medical_specialty`
--
ALTER TABLE `medical_specialty`
