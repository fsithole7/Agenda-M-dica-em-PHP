					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-defaut" type="button" onclick="_reset()"> Cancelar</button>
							</div>
						</div>
					</div>
				</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_cat" type="button" data-id="<?php echo $row['id'] ?>">Remover</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					alert_toast("Actualizado",'success')
					setTimeout(function(){
						location.reload()
					},1500)
	...
	$('.delete_cat').click(function(){
		_conf("Realmente deseja remover?","delete_cat",[$(this).attr('data-id')])
	})
